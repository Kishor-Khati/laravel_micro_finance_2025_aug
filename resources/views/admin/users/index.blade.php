...
@section('subtitle', 'Manage system users and their roles')
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                            @switch($user->role)
                                ...
                                @case('branch_manager') bg-blue-100 text-blue-800 @break
                                @case('field_officer') bg-green-100 text-green-800 @break
                                @case('accountant') bg-yellow-100 text-yellow-800 @break
