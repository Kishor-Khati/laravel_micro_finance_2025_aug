...
@section('title', 'Share Bonus Statements')
@section('subtitle', 'Generate share bonus statements for members')

@section('content')
<div class="space-y-6">
    <!-- Introduction Card -->
    <div class="bg-white rounded-lg shadow p-6">
        <h3 class="text-lg font-semibold text-gray-900 mb-2">Share Bonus Statements</h3>
        <p class="text-gray-600 mb-4">
            Generate detailed share bonus statements showing how bonuses are distributed to members based on their savings balances.
            These statements provide a transparent breakdown of raw income, expenses, and share bonus calculations.
        </p>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Generate Share Bonus Statement</h3>
        
        <form action="{{ route('admin.share-bonus.generate') }}" method="POST" class="space-y-4">
            @csrf
            ...
            <div id="date_range_fields" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="date" name="end_date" id="end_date" value="{{ old('end_date', now()->format('Y-m-d')) }}"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    @error('end_date')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
    ...
    <!-- Recent Statements -->
    <div class="bg-white rounded-lg shadow p-6">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Recent Share Bonus Statements</h3>
            ...
            <div class="flex items-start">
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-yellow-700">
                        <p>Generate your first share bonus statement using the form above. Your recent statements will appear here.</p>
                    </div>
                </div>
            </div>
        </div>
